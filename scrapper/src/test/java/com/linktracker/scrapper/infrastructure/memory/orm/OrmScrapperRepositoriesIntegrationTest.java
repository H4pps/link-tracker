...
import com.linktracker.scrapper.application.tag.TagRepository;
...
import com.linktracker.scrapper.infrastructure.memory.inmemory.InMemoryLinkUpdateCheckpointRepository;
...
import com.linktracker.scrapper.infrastructure.memory.inmemory.InMemoryTagRepository;
import com.linktracker.scrapper.infrastructure.memory.sql.SqlLinkUpdateCheckpointRepository;
import com.linktracker.scrapper.infrastructure.memory.sql.SqlLinkUpdateOutboxRepository;
import com.linktracker.scrapper.infrastructure.memory.sql.SqlScrapperChatRepository;
import com.linktracker.scrapper.infrastructure.memory.sql.SqlScrapperLinkRepository;
import com.linktracker.scrapper.infrastructure.memory.sql.SqlTagRepository;
...
class OrmScrapperRepositoriesIntegrationTest {
    ...
    void ormModeLoadsOnlyOrmRepositories() {
        ...
        assertSingleRepositoryImplementation(LinkUpdateOutboxRepository.class, "OrmLinkUpdateOutboxRepository");
        ...
        assertThat(applicationContext.getBeansOfType(SqlLinkUpdateCheckpointRepository.class))
                .isEmpty();
        assertThat(applicationContext.getBeansOfType(SqlLinkUpdateOutboxRepository.class))
                .isEmpty();
        assertThat(applicationContext.getBeansOfType(SqlTagRepository.class)).isEmpty();
