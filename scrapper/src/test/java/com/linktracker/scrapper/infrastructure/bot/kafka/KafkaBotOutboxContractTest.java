package com.linktracker.scrapper.infrastructure.bot.kafka;
...
class KafkaBotOutboxContractTest {
    ...
    private static final String OUTBOX_REPOSITORY_CLASS =
            "com.linktracker.scrapper.application.update.LinkUpdateOutboxRepository";
    private static final String OUTBOX_EVENT_CLASS =
            "com.linktracker.scrapper.application.update.LinkUpdateOutboxEvent";
