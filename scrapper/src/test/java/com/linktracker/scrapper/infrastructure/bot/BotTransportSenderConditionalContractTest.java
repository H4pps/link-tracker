package com.linktracker.scrapper.infrastructure.bot;
...
class BotTransportSenderConditionalContractTest {
    ...
    void grpcSenderRequiresExplicitGrpcModeAndIsNoLongerMatchIfMissing() {
        Class<?> grpcSenderClass =
                loadRequiredClass("com.linktracker.scrapper.infrastructure.bot.grpc.GrpcBotNotificationSender");
    ...
    void httpSenderRemainsExplicitHttpModeOnly() {
        Class<?> httpSenderClass =
                loadRequiredClass("com.linktracker.scrapper.infrastructure.bot.http.HttpBotNotificationSender");
    ...
    void kafkaSenderExistsAndIsDefaultMatchIfMissingMode() {
        Class<?> kafkaSenderClass = loadRequiredClass(
                "com.linktracker.scrapper.infrastructure.bot.kafka.sender.KafkaBotNotificationSender");
