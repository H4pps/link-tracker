...
import com.linktracker.scrapper.api.rest.errors.dto.ApiErrorResponse;
...
public class ScrapperApiExceptionHandler {
    ...
    private static final String CONFLICT_DESCRIPTION = "Resource state conflict";
    private static final String TOO_MANY_REQUESTS_DESCRIPTION = "Request limit exceeded";
    private static final String INTERNAL_ERROR_DESCRIPTION = "Internal service error";
