package backend.academy.linktracker.ai.support;
 ...
 * whole suite pays the slow Kafka startup cost a single time.
 */
public final class KafkaTestCluster {
    ...
    /**
     * @return the host-mapped Kafka bootstrap servers
     */
    ...
    /**
     * @return the host-mapped Schema Registry URL
     */
