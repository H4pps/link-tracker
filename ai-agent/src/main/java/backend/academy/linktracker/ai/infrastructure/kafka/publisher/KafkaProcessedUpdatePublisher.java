package backend.academy.linktracker.ai.infrastructure.kafka.publisher;

import backend.academy.linktracker.ai.application.ProcessedUpdate;
import backend.academy.linktracker.ai.application.ProcessedUpdatePublisher;
