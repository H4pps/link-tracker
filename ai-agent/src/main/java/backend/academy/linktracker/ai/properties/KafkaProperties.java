...
/**
 * Typed properties for the AI Agent Kafka consumer and producer.
 */
...
public class KafkaProperties {
    ...
    @NotEmpty
    private String rawUpdatesDlqTopic = "link.raw-updates-dlq";

    @NotEmpty
    private String consumerGroup = "ai-agent";
