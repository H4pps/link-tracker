...
import com.linktracker.bot.application.telegram.TelegramOutboundSender;
...
class TelegramBotUpdateUseCaseTest {
    ...
    void sendsNotificationToAllChats() {
        when(outboundSender.sendMessage(10L, "Link update: https://github.com/a/b\nchanged"))
                .thenReturn(true);
        when(outboundSender.sendMessage(20L, "Link update: https://github.com/a/b\nchanged"))
                .thenReturn(true);
    ...
    void oneFailedSendDoesNotStopOtherChats() {
        doThrow(new RuntimeException("boom"))
                .when(outboundSender)
                .sendMessage(10L, "Link update: https://github.com/a/b");

        assertThatThrownBy(() -> useCase.processLinkUpdate(
                        new LinkUpdateCommand(1L, "https://github.com/a/b", null, List.of(10L, 20L))))
                .isInstanceOf(RuntimeException.class);

        verify(outboundSender).sendMessage(20L, "Link update: https://github.com/a/b");
    }
