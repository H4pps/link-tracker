package com.linktracker.bot.infrastructure.kafka;
...
class KafkaLinkUpdateConsumerContractTest {
    ...
    private static final String CONSUMER_CLASS =
            "com.linktracker.bot.infrastructure.kafka.consumer.KafkaLinkUpdateConsumer";
    private static final String MESSAGE_HANDLER_CLASS =
            "com.linktracker.bot.infrastructure.kafka.handler.KafkaLinkUpdateMessageHandler";
    private static final String EVENT_CLASS = "com.linktracker.messaging.ProcessedLinkUpdateEvent";
    private static final String EVENT_MAPPER_CLASS =
            "com.linktracker.bot.infrastructure.kafka.processing.LinkUpdateEventMapper";
    private static final String EVENT_VALIDATOR_CLASS =
            "com.linktracker.bot.infrastructure.kafka.processing.LinkUpdateEventValidator";
    private static final String KAFKA_CONFIGURATION_CLASS =
            "com.linktracker.bot.infrastructure.kafka.config.KafkaConsumerConfiguration";
